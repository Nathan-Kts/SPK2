...
int main()
{
    ...
    double intersection_3[NBR_VECTORS][VECTOR_SIZE];
    double private_lattice_1[NBR_VECTORS][VECTOR_SIZE], private_lattice_2[NBR_VECTORS][VECTOR_SIZE];
    double private_lattice_3[NBR_VECTORS][VECTOR_SIZE];
    ...
    decrypt_babai(NBR_VECTORS, VECTOR_SIZE, private_lattice_g, intersection_3, message, decoded_0);
    total_g = total_g + count_good_decrypt(NBR_VECTORS, secret, decoded_0);

    decrypt_babai(NBR_VECTORS, VECTOR_SIZE, private_lattice_1, intersection_3, message, decoded_1);
